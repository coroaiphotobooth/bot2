          ...
          <div className="flex flex-col gap-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              <div className="glass-card p-6 md:p-10 flex flex-col gap-8 h-fit">
                ...
                {/* AI Model Config */}
                <h3 className="font-heading text-xl text-purple-400 border-b border-white/5 pb-4 mt-6 uppercase italic">AI Model Configuration (Vertex AI)</h3>
                <div className="flex flex-col gap-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      ...
                      <span className="text-[8px] opacity-70 uppercase">VERTEX ID: gemini-2.5-flash-001</span>
                    </button>
                    ...
                    >
                      <span className="text-sm font-bold">GEMINI 3 PRO</span>
                      <span className="text-[8px] opacity-70 uppercase">VERTEX ID: gemini-3.0-pro-001</span>
                    </button>
                  </div>
                </div>

                {/* Video Settings */}
                <h3 className="font-heading text-xl text-purple-400 border-b border-white/5 pb-4 mt-6 uppercase italic">Video Generation (Vertex AI)</h3>
                ...
                <p className="text-[9px] text-gray-500 font-mono">* Model Used: <strong>veo-3.1-fast-generate-preview</strong></p>
